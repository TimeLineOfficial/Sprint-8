...
import { WifiOff, RefreshCw, CheckCircle2, ShoppingBag } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        <div className="flex items-center space-x-2">
          {!isOnline ? (
            <>
              ...
              <span>Offline Browsing Mode Active • Accessing Offline Saved Catalog</span>
            </>
          ) : (
            <>
              <CheckCircle2 className="w-4 h-4" />
              <span>Connection Restored • Synchronizing Data</span>
            </>
          )}
        </div>
        ...
        {queuedCount > 0 && (
          <div className="flex items-center space-x-2 text-[11px]">
            ...
            <span>Pending Sync: {queuedCount} action(s)</span>
